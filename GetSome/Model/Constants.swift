...
struct Constants {
    ...
    /// A constant height for a card's tag row, so cards align whether or not the
    /// video has tags.
    static var tagRowHeight: Double {
    ...
    static let ageGateTextWidth: Double = 420

    /// The app's version and build, for the profile and diagnostics screens.
