...
Abstract:
A button that opens the profile and settings screen.
*/
...
/// A button that opens the profile and settings screen.
///
/// In visionOS the button sits over the Watch Now content and expands on hover to
/// name itself. Everywhere else it's a plain icon that lives in the toolbar, where
/// an expanding overlay would have nothing to expand into.
...
extension Constants {
    static var profileIconSize: CGSize {
        #if os(visionOS)
    ...
    static let profileHeaderIconSize: CGFloat = 52
